...
```bash
git clone https://github.com/dinesh-dk007/dinesh.com.git your-portfolio
cd your-portfolio
```
...
```bash
npx shadcn@latest add https://dinesh.com/r/cn.json
npx shadcn@latest add https://dinesh.com/r/theme-switcher.json
npx shadcn@latest add https://dinesh.com/r/flip-sentences.json
npx shadcn@latest add https://dinesh.com/r/apple-hello-effect.json
```
